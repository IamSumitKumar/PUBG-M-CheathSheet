...
"💠   ʙʟᴀᴄᴋ sᴋʏ", 
" ⚜️【ᴇxɪᴛ 】⚜️", 
},nil, (os.date("┣☬   Technical Support V1 \n┣☬   VIP sᴄʀɪᴘᴛ  : Technical\n┣☬ Support\n┣☬    ᴛᴏᴅᴀʏ: %Y/%m/%d  ᴛɪᴍᴇ: %H:%M:%S"))) 
if MN == nil then 
else 
if MN[1] == true then WC()end 
if MN[2] == true then LR()end 
if MN[3] == true then AH()end 
if MN[4] == true then HJ()end 
if MN[5] == true then MB()end 
if MN[6] == true then BS()end 
if MN[7] == true then EXIT()end 
end 
PUBGMH = -1 
end 
...
function WC() 
 MN1 = gg.multiChoice({ 
      "🏘️ ᴡᴀʟʟ ʜᴀᴄᴋ ᴀʟʟ sɴᴀᴘᴅʀᴀɢᴏɴ", 
      "🏘️  ᴡᴀʟʟ ʜᴀᴄᴋ ᴀʟʟ ᴅᴇᴠɪᴄᴇ", 
      "🏘️  ᴡᴀʟʟ ʜᴀᴄᴋ 400", 
      "🏘️  ᴡᴀʟʟ ʜᴀᴄᴋ 410", 
      "🏘️  ᴡᴀʟʟ ʜᴀᴄᴋ 415", 
      "🏘️  ᴡᴀʟʟ ʜᴀᴄᴋ 425", 
      ...
      "❇️  ᴄᴏʟᴏᴜʀ ᴍɪx", 
      "⎋вαcк", 
}, nil, "┣☬ Technical Support viρ scriρτ\n┣☬ sυвscriвє Technical Support channel") 
if MN1 == nil then 
else 
...
function MB() 
gg.clearResults()  gg.setRanges(gg.REGION_ANONYMOUS) gg.searchNumber('9.20161819458;23;25;30.5', gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1) 
gg.getResultsCount() 
gg.searchNumber('25;30.5', gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1) 
gg.getResults(10) 
gg.editAll('240', gg.TYPE_FLOAT) 
gg.clearResults() 
gg.clearResults() gg.setRanges(gg.REGION_ANONYMOUS) gg.searchNumber('1F;-8.6457681e12F;15F;28F;16F;26F;8F;18F:512', gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1) 
...
function EXIT() 
print("  🌟 Technical Support viρ scriρτ 🌟") 
gg.skipRestoreState() 
gg.setVisible(true) 
  os.exit() 
end 
